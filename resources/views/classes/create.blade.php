...
<div class="max-w-3xl mx-auto">
    <x-card>
        ...
        <x-slot name="subtitle">Lengkapi data kelas di bawah ini</x-slot>
        <x-slot name="actions">
        ...
        <form action="{{ route('classes.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <x-input name="code" label="Kode" placeholder="Contoh: VIP" :required="true" />
                ...
                <div class="md:col-span-2">
                    <x-input name="name" label="Nama" placeholder="Contoh: VIP" :required="true" />
                </div>
